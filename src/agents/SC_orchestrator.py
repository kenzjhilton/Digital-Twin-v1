...
def demo_orchestrated_supply_chain():
    ...
    mine = MiningAgent("MINE_001", "Auto Mine", 1000000.0, ["Phosphorite Ore"], 1000.0)
    ...
    processor = ProcessingAgent("PROC_001", "Auto Processor", 1000.0, ["chemical_processing"], processing_recipes)
    ...
    trace_id = orchestrator.inject_raw_materials("MINE_001", "Phosphorite Ore", 1000.0)
